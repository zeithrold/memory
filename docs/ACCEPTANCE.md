...
- Force deterministic 4xx/schema and transient timeout/429/5xx failures. Only transient failures should retry inside the Workflow; later scheduled attempts must follow the 2h/6h/24h half-hour-aligned backoff.
