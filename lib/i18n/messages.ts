export const en = {
  ...
  packageHint: 'These pending suggestions are reviewed together. Accept applies them in a safe order; reject with advice feeds your note into the next run.',
...
export const zh: Messages = {
  ...
  connectIntro:
    '支持插件的客户端一次安装即可；其他本地 Agent 连接 MCP，并共享同一份可移植 Skill。',
  endpoint: 'MCP 接口地址',
  chatgpt: 'ChatGPT',
  chatgptBody:
  ...
  providerHint:
    '端点必须实现 Responses API 和函数调用。启用之前请先跑一次连接测试。',
  provider: '模型服务',
  providerNone: '未配置',
  providerResponses: 'Responses API 端点',
  providerWorkersAi: 'Workers AI',
  baseUrl: '端点地址',
  model: '模型',
  apiKey: 'API 密钥',
  ...
  revertDone: '本次运行已撤销。',
  proposalDone: '决策已记录。',
  categoryBoundary: '不放什么',
  categoryAxis: '分类轴',
  childCategories: '子分类',
  membersHere: '这里的记忆',
  backToCatalog: '返回目录',
  categoryMissing: '这个分类不在当前目录里。',
  acceptPackage: '全部接受',
  rejectPackage: '全部驳回',
  rejectWithAdvice: '驳回并附建议',
  splitProposals: '逐条决策',
  joinProposals: '合并为一包',
  packageHint: '这些待决策建议会一起审阅。接受会按安全顺序应用；附建议驳回会把你的说明带进下一次运行。',
  adviceLabel: '给下次运行的建议',
  advicePlaceholder: '告诉 Agent 下次该怎么调整…',
  pendingAdviceHint: '下次运行会带上你尚未消费的建议。',
  runPromptTitle: '开始一次目录整理',
  runPromptHint: '可选，仅对本轮生效。这是你给出的可信说明，不是记忆正文。',
  runPromptPlaceholder: '本轮可选指导…',
  startRun: '开始',
  viewSteps: '步骤',
  primaryBadge: '主分类',
  noMemoriesInCategory: '这里还没有挂记忆。',
  openCategory: '打开',
}
