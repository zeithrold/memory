...
// and both the page and `clerkIssuer()` fall back to the value inlined at build
// time, so a developer's real Clerk key would otherwise reach the preview. An
// explicitly empty variable takes precedence over `.env.local`.
const cleared = [
